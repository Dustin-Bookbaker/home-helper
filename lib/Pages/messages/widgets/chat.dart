...
import 'package:homehelper/Pages/messages/widgets/loading.dart';
...
//    id = prefs.getString('id') ?? '';
    await Firestore.instance
        ...
        .where('uid',
            isEqualTo: BlocProvider.of<UserBloc>(context).state.helperUser.uid)
        .getDocuments()
        .then((snapshot) {
      id = snapshot.documents.first.reference.documentID ?? '';
    });
